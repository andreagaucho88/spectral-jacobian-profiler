...
(greedy) leaves impossible-entity prompts the outlier (halluc-vs-others $|d|=0.9$--$2.1$, vs.\
...
Hallucination-prone $=$ entropy outlier & \S\ref{sec:results-output} & all conditions & robust; near-manipulation-check \\
